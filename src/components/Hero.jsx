...
const Hero = () => {
  ...
  const totalVideos = 4
  const nextVedioRef = React.useRef(null)
        ...
        <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75'>
            ...
            <div className='absolute left-0 top-0 z-40 size-full'>
              <div className='mt-24 px-5 sm:px-10'>
                ...
                <p className='mb-5 max-w-65 font-robert-regular text-blue-100'>Enter the Metagame Layer <br/> Unleash the Play Economy</p>
